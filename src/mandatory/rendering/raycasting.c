...
/*   Updated: 2025/01/20 01:51:54 by oel-feng         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (cast->side == 0)
		cast->perpwalldist = (cast->map_x - map_data->player->x_pos_map
				+ (1 - cast->step_x) / 2) / cast->raydir_x;
	else
		cast->perpwalldist = (cast->map_y - map_data->player->y_pos_map
	...
	if (cast->side == 0)
		cast->wall_x = map_data->player->y_pos_map
			+ cast->perpwalldist * cast->raydir_y;
	else
		cast->wall_x = map_data->player->x_pos_map
			+ cast->perpwalldist * cast->raydir_x;
}
...
static void	init_step(t_cast *cast, t_map_data *map_data)
{
	...
	{
		cast->step_x = -1;
		cast->sidedist_x = (map_data->player->x_pos_map
				- cast->map_x) * cast->deltadist_x;
	}
	else
	{
		cast->step_x = 1;
		cast->sidedist_x = (cast->map_x + 1.0
				- map_data->player->x_pos_map) * cast->deltadist_x;
	}
	if (cast->raydir_y < 0)
	{
		cast->step_y = -1;
		cast->sidedist_y = (map_data->player->y_pos_map
				- cast->map_y) * cast->deltadist_y;
	}
	else
	{
		cast->step_y = 1;
		cast->sidedist_y = (cast->map_y + 1.0
				- map_data->player->y_pos_map) * cast->deltadist_y;
	}
}
...
static void	init_data(t_cast *cast, t_map_data *map_data, int x)
{
	...
	cast->raydir_x = map_data->player->dir_x
		+ map_data->player->plane_x * cast->camera_x;
	cast->raydir_y = map_data->player->dir_y
		+ map_data->player->plane_y * cast->camera_x;
